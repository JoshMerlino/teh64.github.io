...
String.prototype.toProperCase = function() {return this.charAt(0).toUpperCase() + this.slice(1);}; $.fn.animateRotate = function(angle, duration, easing, complete) {var args = $.speed(duration, easing, complete);var step = args.step;return this.each(function(i, e) {args.complete = $.proxy(args.complete, e);args.step = function(now) {$.style(e, 'transform', 'rotate(' + now + 'deg)');if (step) return step.apply(e, arguments);};$({deg: 0}).animate({deg: angle}, args);});};
...
!function(){
	...
	$(document).ready(function(){
		...
		$("[color]").each(function(){
			...
			if($(this).is(":button")){
				if(!$(this).hasAttr("md-fab")){
					if(t >= 186){
						$(this).css("color", "rgba(0,0,0,0.5395)");
		...
		$("button[md-flat]").each(function(){
			Waves.attach(this, "waves-medium");
		...
		$(".md-coloropen").click(function(){
			...
			$(".md-colorblob:not(.md-other)").each(function(){
				...
				var l = $(this).position().left + SCREENDPI * 0.80
				var t = $(this).position().top + SCREENDPI * 0.925
